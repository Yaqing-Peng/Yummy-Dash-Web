    ...
    <div class="overviewBox">
      <ul>
        <li>
          ...
          <p class="tip">
            Growth Rate<span v-if="overviewData.turnoverGrowth">
              <span
                class="red"
        ...
        <li>
          ...
          <p class="tip">
            Growth Rate<span v-if="overviewData.validOrderCountGrowth">
              <span
                class="red"
        ...
        <li>
          <p class="tit">Order Complete Rate</p>
          <p class="num">
            {{ (overviewData.orderCompletionRate * 100).toFixed(2) }}%
          </p>
          <p class="tip">
            Growth Rate<span v-if="overviewData.orderCompletionRateGrowth">
              <span
                class="red"
                :class="
        ...
        <li>
          <p class="tit">Average Consumption Per Order</p>
          <p class="num">{{ overviewData.unitPrice.toFixed(2) }}</p>
          <p class="tip">
            Growth Rate<span v-if="overviewData.unitPriceGrowth">
              <span
                class="red"
        ...
        <li>
          ...
          <p class="tip">
            Growth Rate<span v-if="overviewData.newUsersGrowth">
              <span
                class="red"
                :class="overviewData.newUsersGrowth > 0 ? '' : 'green'"
                >{{
